...
export const ONBOARDING_STEPS: readonly OnboardingStepDefinition[] = [
  {
    ...
    description: 'Capture the dealer’s WhatsApp number so the rest of the journey can reach them.',
  ...
  },
  {
    ...
    description: 'Send the introductory WhatsApp message and confirm the dealer received it.',
    fieldsCaptured: [],
    mutating: false,
    reopenable: true,
  },
  ...
  },
  {
    ...
    description: 'Generate or confirm a unique dealer code (e.g. E01). Used to name the WhatsApp groups.',
    fieldsCaptured: ['code'],
    mutating: true,
    reopenable: false,
  },
  {
    id: 'create-admin-group',
    order: 7,
    title: 'Create admin-led WhatsApp group',
    description:
      'Create the ${code}01 group with us as admin, send the welcome message, ask for portal credentials.',
    fieldsCaptured: ['whatsappGroups.adminGroupName', 'portalCredentials'],
    mutating: true,
    reopenable: true,
  },
  {
    id: 'create-dealer-group',
    order: 8,
    title: 'Create dealer-led WhatsApp group',
    description:
      'Create the ${code}02 group with the dealer as admin so they can add their team.',
    fieldsCaptured: ['whatsappGroups.dealerGroupName'],
    mutating: false,
    reopenable: true,
  },
];
